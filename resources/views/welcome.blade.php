    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                ...
                <div><a class="btn mt-3 bg-gradient-primary" href="{{ route('login') }}">Application</a></div>
            </div>
        </div>
    </nav>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    <h2 class=" fw-bold mb-3">Effortlessly Manage Employee Leave with Our Advanced Leave Tracker! </h2>
                    <p class="lead text-muted mb-4">Streamline Leave Requests, Track Attendance, and Optimize Workforce
                        Management Effortlessly.</p>
                    <div class="d-flex flex-wrap"><a class="btn bg-gradient-primary me-2 mb-2 mb-sm-0"
                            href="{{ route('login') }}">Application</a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="text-muted mb-5">Dhaka Bangladesh 1216-Mirpur</p>
                    <h4 class="fw-bold">Contact Us</h4>
                    <p class="text-muted mb-1">mamonkhan14108@gmail.com</p>
                    <p class="text-muted mb-0">+01768085606</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <form action="#">
